...
def get_bet():
    ...
    while True:
        amount = input("\nWhat would like to bet on each line? $")
...
def spin(balance):
    ...
    winnings, winnings_lines = get_winnings(slots, lines, bet, symbol_value)
    print(f"\nYou won ${winnings}\n")
...
def main():
    ...
    print(f"\nYour balance left with ${balance}.")
